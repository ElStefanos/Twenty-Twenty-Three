...
<section class="pageSection">
    ...
    <section class="presentation block">
        <div class="container block">
            <img src="<?php echo $theme->getAssetLink("/assets/images/product-shot-p-800.webp"); ?>" alt="Product shot"
                class='block'>
            <h2 class="block">Sleek and modern theme for your next project</h2>
            <p class="block"> Upgrade your website with our cutting-edge theme designed to make a lasting impression.
                Our
